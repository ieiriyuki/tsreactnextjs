...
/**
 * convert Responsive type to CSS property and its value
 * @param propKey CSS property
 * @param prop Responsive type
 * @param theme Theme
 * @returns CSS property and its value
 */
...
/**
 * convert to value of css property defined in theme
 * @param propKey CSS property
 * @param value CSS property value
 * @param theme AppTheme
 * @returns value of css property defined in theme
 */
